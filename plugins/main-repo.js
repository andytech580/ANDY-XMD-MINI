...
export default {
  ...
  run: async (client, m) => {
    try {
      ...
      const botname = botSettings.namebot2 || '𝑨𝑵𝑫𝒀-𝑿𝑴𝑫 𝑴𝑰𝑵𝑰';
      const banner = botSettings.banner || 'https://n.uguu.se/nQFWCVxU.jpg';
      ...
      const description = repoInfo.description || '𝑨𝑵𝑫𝒀-𝑿𝑴𝑫 𝑴𝑰𝑵𝑰- Advanced WhatsApp Bot with Gacha, Economy, AI and more!';
      ...
      const commitAuthor = lastCommit ? lastCommit.author : 'ANDY-TECH';
