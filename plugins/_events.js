        ...
        const smallThumbContext = {
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              ...
              serverMessageId: '0',
              newsletterName: global.db.data.settings[botId]?.nameid || '𝑨𝑵𝑫𝒀-𝑿𝑴𝑫 𝑴𝑰𝑵𝑰'
            },
            externalAdReply: {
              title: global.db.data.settings[botId]?.namebot || '𝑨𝑵𝑫𝒀-𝑿𝑴𝑫 𝑴𝑰𝑵𝑰',
              body: global.dev || 'Automatic Notification',
              mediaUrl: null,
              description: null,
              previewType: 'PHOTO',
              thumbnailUrl: global.db.data.settings[botId]?.icon || pp,
              sourceUrl: global.db.data.settings[botId]?.link || 'https://github.com/andytech580/ANDY-XMD MINI',
              mediaType: 1,
...
╰─⊷ ${global.db.data.settings[botId]?.namebot || '𝑨𝑵𝑫𝒀-𝑿𝑴𝑫 𝑴𝑰𝑵𝑰'} ⊶─╯`
