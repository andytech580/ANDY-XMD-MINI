  ...
  run: async (client, m, args, command, text) => {
    try {
      ...
      if (currentInfo.commit === latestCommit.commit) {
        await reloadCommands();
        return m.reply(`✅ *𝑨𝑵𝑫𝒀-𝑿𝑴𝑫 𝑴𝑰𝑵𝑰 𝑰𝑺 𝑼𝑷 𝑻𝑶 𝑫𝑨𝑻𝑬*\n\n` +
